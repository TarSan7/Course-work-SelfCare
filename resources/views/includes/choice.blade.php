<link rel="stylesheet" href="{{asset('public/css/choice.css')}}">
        ...
        <form action="basket{{$id}}" method="post">
            ...
            <div class="wrapper">
                <div class="checkbox">
                    ...
                    <label for="checkbox">
                        <img src="{{asset('public/img/yogaPhoto.png')}}" />
                        <p><span>Йога</span></p>
                    </label>
                </div>
                ...
                <div class="checkbox">
                    ...
                    <label for="checkbox2">
                        <img src="{{asset('public/img/meditationPhoto.png')}}" />
                ...
                <div class="checkbox">
                    ...
                    <label for="checkbox3">
                        <img src="{{asset('public/img/eatPhoto.png')}}" />
